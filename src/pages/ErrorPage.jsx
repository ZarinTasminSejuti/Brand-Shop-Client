...
const ErrorPage = () => {
  return (
    <div>
      {/* <!-- component --> */}
      <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-black ">
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center bg-base-100 shadow-md rounded-md py-8">
          <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">
            404
          </p>
         
            <img className=" w-1/2 mt-7" src="https://i.ibb.co/DY2XSty/404.png"/>
